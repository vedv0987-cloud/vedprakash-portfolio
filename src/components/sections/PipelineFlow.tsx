  ...
  return (
    <section id="pipeline" className="py-24 md:py-36 px-6 lg:px-12 max-w-[1400px] mx-auto">
      ...
      <div className="mb-16 pb-8 border-b border-black/[0.08]">
        ...
        <h2 className="text-[clamp(2.25rem,5vw,4rem)] font-light tracking-tight text-[#111111] leading-[1.08] max-w-4xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-px bg-black/[0.08] border border-black/[0.08] rounded-2xl overflow-hidden mb-12">
          ...
          return (
            <button
              ...
              className={`p-6 text-left transition-colors cursor-pointer ${
                isSelected ? 'bg-[#111111] text-white' : 'bg-white text-[#111111] hover:bg-[#fafaf8]'
              }`}
            >
              <span className={`font-mono text-xs block mb-3 ${isSelected ? 'text-[#8e8e93]' : 'text-[#8e8e93]'}`}>
                PHASE {item.step}
              </span>
      ...
      <div className="bg-white rounded-3xl p-8 sm:p-12 border border-black/[0.08] shadow-xs">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-8 border-b border-black/[0.08]">
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl font-light tracking-tight text-[#111111] mt-1">
                  {pipelineWorkflow[activeStep].phase}
                </h3>
              </div>

              <div className="flex items-center gap-2">
                <span className="text-xs text-[#8e8e93] font-mono uppercase">Tools:</span>
            ...
            <p className="mt-8 text-lg text-[#666664] leading-relaxed max-w-3xl font-normal">
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-black/[0.08]">
              <div>
                <span className="text-xs font-mono text-[#8e8e93] uppercase block">Output Integrity</span>
                <p className="text-sm font-semibold text-[#111111] mt-1">Lossless Master Asset</p>
              </div>
              <div>
                <span className="text-xs font-mono text-[#8e8e93] uppercase block">Visual Quality Control</span>
                <p className="text-sm font-semibold text-[#111111] mt-1">Seed & Character Locked</p>
              </div>
              <div>
                <span className="text-xs font-mono text-[#8e8e93] uppercase block">Efficiency Metric</span>
                <p className="text-sm font-semibold text-[#111111] mt-1">40–60% Timeline Compression</p>
              </div>
            </div>
          </motion.div>
        </AnimatePresence>
