    ...
    <section id="hero" className="relative min-h-screen w-full flex flex-col justify-between pt-32 pb-16 px-6 lg:px-12 overflow-hidden">
      ...
      <div className="relative max-w-[1400px] w-full mx-auto flex-1 flex flex-col justify-between z-10">
        ...
        >
          ...
          <div className="flex items-center gap-6 text-xs text-white/80 font-mono">
        ...
        >
          ...
          <div className="p-8 sm:p-12 md:p-14 rounded-3xl bg-white/[0.08] backdrop-blur-2xl border border-white/20 shadow-2xl max-w-5xl">
            ...
            <motion.div variants={fadeUp} className="flex flex-col gap-2">
              ...
              <h1 className="text-[clamp(2.25rem,5.5vw,4.75rem)] font-light tracking-tight text-white leading-[1.06]">
                Directing{' '}
                <span className="inline-block relative min-h-[1.15em] overflow-hidden align-bottom">
                  <AnimatePresence mode="wait">
                    <motion.span
                      ...
                      className="serif-italic font-normal text-white inline-block underline decoration-white/30 underline-offset-8"
                    >
                      {heroRoles[roleIndex]}
                    </motion.span>
                  </AnimatePresence>
            ...
            <motion.p variants={fadeUp} className="mt-6 text-base sm:text-lg text-white/85 max-w-3xl leading-relaxed font-normal">
              {siteConfig.shortBio}
            </motion.p>
            ...
            <motion.div variants={fadeUp} className="mt-9 flex flex-wrap gap-3.5 items-center">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 text-white border border-white/30 px-6 py-3.5 rounded-full text-xs font-mono uppercase tracking-wider font-semibold transition-all duration-200 backdrop-blur-lg hover:scale-[1.02] active:scale-98 cursor-pointer"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/20 px-5 py-3.5 rounded-full text-xs font-mono uppercase tracking-wider font-semibold transition-all duration-200 backdrop-blur-lg hover:scale-[1.02] active:scale-98"
              >
                <span>Behance ↗</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-wider text-white/80 hover:text-white px-4 py-3.5 transition-colors"
              >
        ...
        >
          {keyStats.map((stat, i) => (
            <div key={i} className="flex flex-col">
              ...
              <span className="text-[11px] text-white/60 mt-0.5 font-mono">
                {stat.sublabel}
              </span>
            </div>
          ))}
